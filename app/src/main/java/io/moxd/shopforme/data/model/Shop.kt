...
data class ShopGSON(val id: Int ,val price : Double, val helpsearcher : UserME ,val creation_date : String, val buylist: BuyList , val helper: UserME? , val payed : Boolean , val done : Boolean , val bill_hf : String? , val bill_hfs : String? , val payed_prove : String? , val raiting :Int , val finished_date : String?) : java.io.Serializable {
}
